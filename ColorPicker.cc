...
ColorPicker::ColorPicker(Frame *parent, Listener *listener, unsigned char r,
    ...
    XmString s = XmStringCreateLocalized((char *) "Pick a color:");
    ...
    s = XmStringCreateLocalized((char *) "Original:");
    ...
    s = XmStringCreateLocalized((char *) "New:");
    ...
    s = XmStringCreateLocalized((char *) "Red:");
    ...
    s = XmStringCreateLocalized((char *) "Green:");
    ...
    s = XmStringCreateLocalized((char *) "Blue:");
    ...
    s = XmStringCreateLocalized((char *) "OK");
