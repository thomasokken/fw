...
SettingsDialog::SettingsDialog(Plugin *plugin, SettingsHelper *settings)
    ...
    xms = XmStringCreateLocalized((char *) " 1 Bit ");
    ...
    xms = XmStringCreateLocalized((char *) " 8 Bits");
    ...
    xms = XmStringCreateLocalized((char *) "24 Bits");
    ...
    xms = XmStringCreateLocalized((char *) "OK");
    ...
    xms = XmStringCreateLocalized((char *) "Cancel");
    ...
    xms = XmStringCreateLocalized((char *) "Help");
